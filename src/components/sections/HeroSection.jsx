...
function HeroSection() {
  ...
  return (
    <section
      id="hero" 
      className={`mx-auto px-20 py-20 flex flex-col items-center md:flex-row md:pl-52 gap-14 transition-colors duration-300 ${
    ...
    >
      <div className="md:w-1/2">
        ...
        <Link to="/pokemon">
          <button className="bg-yellow-400 hover:bg-yellow-300 text-gray-900 px-6 py-3 rounded-lg font-bold text-lg flex items-center gap-2 transition-colors">
            Explorer maintenant
          </button>
        </Link>
      </div>
